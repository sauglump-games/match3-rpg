...
import { createQuestRunner, createQuestRunnerFromSnapshot } from './quest-runner.js';
...
export class Game {
    ...
    toJSON() {
        return {
            ...
            generatedQuests: deepClone(this.generatedQuests),
            questRunnerSnapshots: this.questRunners.map(r => r.toSnapshot()),
            questRewardsFired: Array.from(this.questRewardsFired),
            questRewardMessages: { ...this.questRewardMessages },
        };
    }
    ...
    static fromJSON(data) {
        ...
        // Rehydrate generated quests + runners from snapshots. The constructor
        // above already seeded a fresh set from the freshly-generated map;
        // those get discarded here in favor of the saved state.
