...
//   id, name, slot, rarity, classes (who may equip), bonuses {damageBonus, armorBonus, maxHpBonus, maxManaBonus}
//
...
export const ITEMS = {
    ...
    'mage-robe': {
        ...
        classes: ['mage'],
        bonuses: { armorBonus: 1, maxManaBonus: 5 },
        description: '+1 armor, +5 max mana. Mages only.',
    },
    // ----- shields -----
    'buckler': {
    ...
    'amulet-of-the-adept': {
        ...
        classes: ['mage', 'cleric', 'druid'],
        bonuses: { maxManaBonus: 10 },
        description: '+10 max mana. Casters only.',
    },
    'boots-of-valor': {
    ...
    'wand-of-magic-missiles': {
        ...
        classes: ['mage'],
        bonuses: { damageBonus: 3, maxManaBonus: 5 },
        description: '+3 damage, +5 max mana. Mage focus.',
    },
    'sun-blade': {
    ...
    'mage-armor': {
        ...
        classes: ['mage'],
        bonuses: { armorBonus: 2, maxManaBonus: 8 },
        description: '+2 armor, +8 max mana. Spell-woven shielding.',
    },
    'adamantine-mail': {
    ...
    'robe-of-stars': {
        ...
        classes: ['mage'],
        bonuses: { armorBonus: 2, maxManaBonus: 14 },
        description: '+2 armor, +14 max mana. Stars wheel across the cloth.',
    },
    ...
    'spellguard-shield': {
        ...
        classes: ['warrior', 'paladin', 'cleric'],
        bonuses: { armorBonus: 3, maxManaBonus: 6 },
        description: '+3 armor, +6 max mana. Wards off both spell and steel.',
    },
    ...
    'headband-of-intellect': {
        ...
        classes: ['mage', 'cleric', 'druid'],
        bonuses: { maxManaBonus: 14 },
        description: '+14 max mana. The wearer\'s thoughts run clearer.',
    },
    'bracers-of-defense': {
